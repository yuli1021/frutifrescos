<?php
// --- ARCHIVO: includes/chatbot.php ---
// Descripción: Estructura HTML y CSS para el chatbot flotante.
?>
<div id="chatbot-container">
    ...
    <div id="chatbot-window" class="hidden">
        ...
        <div class="chatbot-body" id="chatbot-body">
            <div class="chat-message bot">¡Hola! Soy tu asistente virtual. ¿Cómo puedo ayudarte hoy?</div>
        </div>
